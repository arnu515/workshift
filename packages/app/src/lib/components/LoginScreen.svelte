...
>
	...
	>
		...
		<div class="flex flex-col gap-2 justify-center">
			<a href="{axios.defaults.baseURL}/connect/github" class="provider bg-[#181717] text-white">
			...
			<a href="{axios.defaults.baseURL}/connect/discord" class="provider bg-[#5865f2] text-white">
				<svg role="img" viewBox="0 0 24 24" class="fill-white" xmlns="http://www.w3.org/2000/svg"
